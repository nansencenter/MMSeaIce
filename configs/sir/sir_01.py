...
train_options = {
    ...
    'join_classes': {
        'sir_eqs0250': {0: [0, 1, 2, 3, 4], 1: [5, 6, 7, 8, 9]},
        'sir_eqs4000': {0: [0, 1, 2, 3, 4], 1: [5, 6, 7, 8, 9]},
        'rfs_eqs0250': {0: [0, 1, 2, 3, 4], 1: [5, 6, 7, 8, 9]},
        'rfs_eqs4000': {0: [0, 1, 2, 3, 4], 1: [5, 6, 7, 8, 9]},
        'mss_eqs0500': {0: [0, 1, 2, 3, 4], 1: [5, 6, 7, 8, 9]},
        'mss_eqs4000': {0: [0, 1, 2, 3, 4], 1: [5, 6, 7, 8, 9]},
    },
}
