...
train_options = {
    ...
    'path_to_train_data': 'ready_to_train2',
    'path_to_test_data': 'ready_to_train2',
    ...
    'train_list_path': 'datalists/rtt2_trn.json',
    # Which validation set is going to be used
    'val_path': 'datalists/rtt2_val.json',
    'task_weights': [1, 1],
    'charts': ['SIC', 'SOD'],
    ...
    'mask_for_cropping': {'index': 1, 'chart': 'SOD'},
}
